...
import { BarChart2, ChevronRight, Clock, Database, Loader2, Trash2 } from "lucide-react"
          ...
          <li key={category.id} className="relative group z-10 transition-all duration-200 hover:-translate-y-0.5">
            ...
            <div className="relative p-6 z-10">
              <div className="flex items-center gap-4 mb-6">
                ...
                />
                <div>
                  <h3 className="text-lg/7 tracking-tight text-gray-950">{category.emoji || "📂"} {category.name}</h3>
              ...
              <div className="flex items-center justify-between mt-4">
                <Link
                  ...
                  className={buttonVariants({ variant: "outline", size: "sm", className: "flex items-center text-sm" })}
                >
      ...
      >
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm/6 text-gray-600">
              Are you sure you want to delete the category <strong>{deletingCategory}</strong>?
              <br />
            ...
            >
              {isDeletingCategory ? (
                <div className="inline-flex items-center">
                  <Loader2 className="size-4 animate-spin mr-2" /> Deleting</div>
              ) : "Delete"}
            </Button>
          </div>
        </div>
